...
<body>
	<div id="background">
		...
		<div id="info2">
			...
			<div style="position: absolute;top: -85px;left: 340px;"><h2 style="color:blue;">%nomEtudiant%</h2></div>
			<div style="position: absolute;top: -65px;left: 340px;"><h2 style="color:blue;">%prenomEtudiant%</h2></div>
			<div style="position: absolute;top: -35px;left: 360px;"><p>%mailEtudiant%</p></div>
